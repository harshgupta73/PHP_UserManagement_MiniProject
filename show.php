    ...
    <body>
        ...
        <main>
            <form action="" method="POST">
                <div
                    class="container mt-5 rounded border box-shadow p-5"
                >
                    <table border="1" cellpadding="10" cellspacing="01" align="center" style="background: linear-gradient(to right,lightblue,lightyellow);">
                        <tr>
                            <th>Product Id</th>
                            <th>Product Name</th>
